(function( window, $, undefined ) {
	...
	$.elastislide.prototype 	= {
		_init 				: function( options ) {
			...
			this.$dreamCarousel	= this.$slider.parent();
		...
		_configure			: function() {
			...
			// the ul's parent's (div.dreamCarousel) width is the "visible" width
			this.visibleWidth	= this.$dreamCarousel.width();
		...
		_setCurrentValues	: function() {
			...
			// the ul parent's (div.dreamCarousel) width is the "visible" width
			this.visibleWidth	= this.$dreamCarousel.width();
